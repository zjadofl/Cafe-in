    ...
    <div class="content">
      ...
      $.ajax({
        ...
        success: function(data) {
         ...
         queryObjectLen1 = queryObject1.listRefuse.length;
         //alert(queryObject1.listRefuse[0].type);
         //alert(queryObjectLen1);
          for (var i = 0; i < queryObjectLen1; i++) {
             var reason = queryObject1.listRefuse[i].reason;
             //alert(reason);
             var reason_cnt = queryObject1.listRefuse[i].cntReason;
             //alert(reason_cnt);
             myChart1.data.labels.push(reason);
             myChart1.data.datasets[0].data.push(reason_cnt);
          }
          myChart1.update();
        },

 ...
 * Generated at: 2019-10-17 14:11:17 UTC
...
public final class employeeManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1 class=\"m-0 text-dark\">직원 관리</h1>\r\n");
      out.write("          </div><!-- /.col -->\r\n");
      out.write("          <div class=\"col-sm-6\">\r\n");
      ...
      out.write("                ");
	                ...
	                int emNum;
	                String emName, emID, emPW, emPos;
                	ConnectDB connectDB = ConnectDB.getInstance();
	            	Connection con = connectDB.openConnection();
	            	Statement stmt = con.createStatement();
	            	String sql = "select ep_num, ep_name, ep_id, ep_pw," +
           			"(CASE ep_pos " +
	            	"WHEN 'o' THEN '점주' " +
	            	"WHEN 'e' THEN '직원' " +
	            	"END " +
	        		...
	        		while(rs.next()) {
	        			emNum = rs.getInt(1);
	        			emName = rs.getString(2);
	        			emID = rs.getString(3);
	        			emPW = rs.getString(4);
	        			emPos = rs.getString(5);

 ...
 * Generated at: 2019-10-18 08:50:41 UTC
...
public final class orderManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("              <h3 class=\"card-title\">테이블</h3>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("                ");
                   ...
                   //String sql = "select mn_name, od_price from order_ where order_.mn_num = menu.mn_num";
                   String sql = "select mn_name, od_price from order_";
                   ResultSet rs = stmt.executeQuery(sql);
                  
                 while(rs.next()) {
                    //orderNum = rs.getInt(1);
                    menuName = rs.getString(1);
                    orderPrice = rs.getInt(2);

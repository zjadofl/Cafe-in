  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">재료관리</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card">
         ...
         <div class="card-body">
           <table id="menuTBL" class="table table-bordered table-striped">
             ...
             <% //재고 정보 가져오기.
                int in_num;
                String in_name, in_amnt;
                ConnectDB connectDB = ConnectDB.getInstance();
                Connection con = connectDB.openConnection();
                Statement stmt = con.createStatement();
                String sql = "select in_num, in_name, format(in_amnt, 0) "
                      + "from ingredient ";
                ...
                while(rs.next()) {
                   ...
                   in_amnt = rs.getString(3);
                   String color = null;
                   String soldOut = null;
                   if (rs.getInt(3) <= 400 ){ //적정 수량보다 값이 작을 때
                      color = "red";
                   } 
                   if (rs.getInt(3) == 0){
                	   soldOut = "(품절)";

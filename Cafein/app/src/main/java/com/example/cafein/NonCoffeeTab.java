 ...
 */
public class NonCoffeeTab extends Fragment {

    private RecyclerView recyclerNonCoffee;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_non_coffee_tab, null);

        recyclerNonCoffee = view.findViewById(R.id.recycleNonCoffee);
        recyclerNonCoffee.setHasFixedSize(true);
        //recyclerView.setLayoutManager(new GridLayoutManager(getActivity(),2));
        gridLayoutManager = new GridLayoutManager(getActivity(), 2);
        gridLayoutManager.setOrientation(GridLayoutManager.VERTICAL);
        recyclerNonCoffee.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
        recyclerNonCoffee.setLayoutManager(gridLayoutManager);

        arrayList= new ArrayList<Menu>();

        NonCoffeeJsonTask menuJsonTask = new NonCoffeeJsonTask();
    ...
    class NonCoffeeJsonTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                //URL url = new URL("https://api.myjson.com/bins/14kpwv");
                //URL url = new URL("https://api.myjson.com/bins/qsrc6");
                URL url = new URL("http://cafein.freehost.kr/readNonCoffee.jsp");
                ...
                String menuStr = jsonObject.getString("noncoffee");
                ...
                for (int i = 0; i < menuArr.length(); i++) {
                    ...
                    Log.i("mAmnt", mAmnt.toString());
                    Log.i("inAmnt", inAmnt.toString());
        ...
        protected void onPostExecute(String s) {
            ...
            recyclerNonCoffee.setAdapter(menuAdapter);

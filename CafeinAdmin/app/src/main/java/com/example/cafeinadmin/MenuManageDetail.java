...
public class MenuManageDetail extends AppCompatActivity implements View.OnClickListener {
    ...
    String temperature, cup, unitPrice, size,img,price,soprice;
    int totalPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iceBtn.setOnClickListener((View.OnClickListener) this);
        storeCupCBtn.setOnClickListener((View.OnClickListener) this);
